...
INTERR          EQU     $E200           ;INTERRUPTORES 1=ON 0=OFF
...
SONG            EQU     INTERR+1        ;DBNº DE CANCION
...
PUNTERO_P       EQU     INTERR+$2E      ;DW PUNTERO DEL CANAL EFECTOS
CANAL_P         EQU     INTERR+$30      ;DW DIRECION DE INICIO DE LOS EFECTOS
PUNTERO_P_DECP	EQU	    INTERR+$32	;DW PUNTERO DE INICIO DEL DECODER CANAL P
PUNTERO_DECP	  EQU	    INTERR+$34	;DW PUNTERO DECODER CANAL P

;EFECTOS DE SONIDO

N_SONIDO        EQU     INTERR+$36      ;DB : NUMERO DE SONIDO
PUNTERO_SONIDO  EQU     INTERR+$37      ;DW : PUNTERO DEL SONIDO QUE SE REPRODUC


;DB [13] BUFFERs DE REGISTROS DEL PSG

PSG_REG         EQU     INTERR+$40
PSG_REG_SEC	    EQU	    INTERR+$50
ENVOLVENTE	    EQU	    INTERR+$60	;DB : FORMA DE LA ENVOLVENTE
